...
7. **Потокобезопасность**: Не является потокобезопасным по умолчанию (можно сделать потокобезопасным с внешним мьютексом)
...
| **Версия ESP-IDF** | Тестировалось с v6.0.0 |
